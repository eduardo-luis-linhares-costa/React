...
import BigRectangleAbout from '../Components/BigRectangleAbout/BigRectangleAbout';
import SectionColumn from '../Components/SectionColumn/SectionColumn';
import SmallRectangleAbout from '../Components/SmallRectangleAbout/SmallRectangleAbout';
...
function ProfileCard() {
    return (
        <>
            ...
            <Section>
             <SmallRectangleAbout title='EXPERIENCE' year='2007-2017' course='Framer Designer & Developer' school='Bluebase Designs' secondYear='2017-2023' secondCourse='Front-End Developer' SecondSchool='Larsen & Toubro' />
             <SmallRectangleAbout title='EDUCATION' year='2004-2007' course='Bachelor Degree in Psychology' school='University of California' secondYear='2007-2009' secondCourse='Master Degree in Designing' SecondSchool='University of Texas' />
            </Section>
            <Section>
