import BasketBallIcon from '../../assets/ep--basketball.svg';
import BirdIcon from '../../assets/ph--bird-thin.svg';
...
function SmallcardIcons({ title, subtitle, }: propscard) {
